...
export default function Home({ userCount }: { userCount: number }) {
    ...
    const copy = () => {
        navigator.clipboard.writeText(
            `[![Discord Presence](https://gitcard.codevizag.com/api/${userId})](https://discord.com/users/${userId})`
        );
        setCopyState("Copied!");
            ...
            <Main>
                <Container>
                    ...
                    {userId ? (
                        <>
                            <Output>
                                [![Discord Presence](https://gitcard.codevizag.com/api/{userId}
                                )](https://discord.com/users/{userId})
                            </Output>
                            <ActionButton onClick={copy}>{copyState}</ActionButton>
                            <a
                                href="https://github.com/PHPxCODER/lanyard-profile-readme#options"
                                target="_blank"
                                rel="noreferrer"
                            >
                            ...
                            >
                                <Example
                                    src={`/api/${userId}`}
                                    alt={`${userError || "Please Provide a Valid Discord User ID!"}`}
                                    style={{ color: "#ff8787" }}
                                />
                            </a>
                        </>
